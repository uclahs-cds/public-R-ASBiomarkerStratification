...
lapply(demographic.vars, demographics.boxplot, biodb = biodb, x = "BiopsyUpgraded", cond = "Race");
```

#### Progressed to Treatment
```{r, results= 'hide'}
demographic.vars <- c("Age", "Weight", "Height", "BMI");
lapply(demographic.vars, demographics.boxplot, biodb = biodb, x = "ProgressedToTreatment", cond = "Race");
```
