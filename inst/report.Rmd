...
```{r}
seed <- 1313
prog.xgb.F.model <- readRDS(here('models/xgb_ProgressedToTreatment_F_model.RDS'));
prog.rpart.F.model <- readRDS(here('models/rpart_ProgressedToTreatment_F_model.RDS'));
prog.gbm.F.model <- readRDS(here('models/gbm_ProgressedToTreatment_F_model.RDS'));
...
dotplot(bx.resamps, metric = c("F", "ROC", "AUC", "Accuracy"), main = "Biopsy Upgraded Model Comparision")
...
dotplot(prog.resamps, metric = c("F", "ROC", "AUC", "Accuracy"), main = "Progressed To Treatment Model Comparision")
...
dotplot(prostate.resamps, metric = c("F", "ROC", "AUC", "Accuracy"), main = "Prostatectom Model Comparision")
...
compare.var.imp(prog.model.list)
```
