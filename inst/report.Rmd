...
cols <- c("target", "model", "method", "threshold", "Accuracy", "Sensitivity", "Specificity", 
...
thresholds.table[, num.cols] <- lapply(thresholds.table[, num.cols], function(x) round(as.numeric(x), 3))

kable(thresholds.table, digits = 3, row.names = FALSE) %>%
