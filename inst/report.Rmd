...
### Progressed To Treatment
```{r}
prog.gbm.preds <- as.factor(predict(models$ProgressedToTreatment$gbm > optimal.thresholds$ProgressedToTreatment$gbm,))
levels(prog.gbm.preds) <- c('0', '1')
# prog.gbm.preds[is.na(progression.surv.bx)] <- NA
