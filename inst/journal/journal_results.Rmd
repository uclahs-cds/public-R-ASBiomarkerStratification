...
# attr(biodb$Ethnicity, 'label') <- 'Ethnicity'
...
flextable::save_as_docx(demo.table, path = here::here('euro_urology/tables/demographics.docx'))
```
...
seq.model.id <- paste('sequential6', target, metric, seed, sep = '_');
